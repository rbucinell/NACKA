...
import com.rbucinell.nacka_kickball.Data.*;
import com.rbucinell.nacka_kickball.Tasks.*;
		...
		try 
		{
			...
			for( ScheduledMatchUp match : schedule)
			{
				...
				MatchupListItem mli = new MatchupListItem( 
						...
						match.toString(),
						ContextCompat.getColor(this.getBaseContext(),R.color.black_overlay),//getResources().getColor(back_color),
